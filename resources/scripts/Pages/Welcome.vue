            ...
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#ff2d20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        ...
                        <template v-if="route().has('login')">
                            <nav class="-mx-3 flex flex-1 justify-end">
                                <template v-if="$page.props.authenticated">
                                    <Link :href="route('dashboard')" class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#ff2d20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                                        Dashboard
                                    </Link>
                                </template>
                    ...
                    <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                        Laravel v{{ $page.props.laravel_version }} (PHP v{{ $page.props.php_version }})
                    </footer>
                </div>
            </div>
        </div>
